...
contract PlayDuzzle is AccessControl {
    ...
    Dal public dalToken;
    // event DeployedDal(address dalTokenAddress);

    BlueprintItem public blueprintItemToken;
    // event DeployedBlueprintItem(address blueprintItemTokenAddress);

    PuzzlePiece puzzlePieceToken;
    // event DeployedPuzzlePiece(address puzzlePieceTokenAddress);
    ...
    constructor(
        ...
        // emit DeployedDal(address(dalToken));

        // blueprintItemToken = new BlueprintItem(bluePrintBaseUri, address(this));
        // emit DeployedBlueprintItem(address(blueprintItemToken));

        // puzzlePieceToken = new PuzzlePiece(puzzlePieceBaseUri, address(this));
        // emit DeployedPuzzlePiece(address(puzzlePieceToken));
